CREATE TABLE "builds" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "UQ_a29eb7193a0ae25272dfacf51f4" UNIQUE ("name"), CONSTRAINT "PK_c181c897db1d7b044faace6e86c" PRIMARY KEY ("id"));
